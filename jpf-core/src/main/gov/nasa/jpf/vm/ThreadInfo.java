...
**/
  ...
  public Instruction executeInstruction () {
    Instruction pc = getPC();
    /*
    if (pc.getFileLocation().startsWith("SimpleProgram") || pc.getFileLocation().startsWith("MyThread")) { //add
    	System.out.println("fileLocation:" + pc.getFileLocation() + 
        		",filePos:" + pc.getFilePos() + 
        		",instructionIndex:" + pc.getInstructionIndex() +
        		",lineNumber:" + pc.getLineNumber());
    }
    */
